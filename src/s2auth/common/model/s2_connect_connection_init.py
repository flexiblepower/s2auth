...
#   filename:  s2-connect-connection-init.yml
...
class CommunicationDetails(BaseModel):
    communicationProtocol: Literal[CommunicationProtocol]   # type: ignore
...
class UnpairPostRequest(BaseModel):
    clientNodeId: NodeId | None = None
    serverNodeId: NodeId | None = None

...
from s2auth.gen_protocol.models import (
    ConnectionDetails,
...
def post_confirm_access_token() -> ConfirmAccessTokenPostResponse:
    """
...
def initiate_connection(
    body: InitiateConnectionPostRequest = None,
) -> Union[InitiateConnectionPostResponse, CommunicationDetailsErrorMessage]:
    """
...
def unpair(body: UnpairPostRequest = None) -> None:
    """
    Unpair two S2Nodes.
    """
    pass
